window.onload = function() {
	...
	$('.ok').on('click', function() {
		if (q == 0) {
			...
			sessionStorage.setItem("Math", document.body.innerHTML.replace(document.body.innerHTML.substr(660,103), ""))
		}
		q++;
	});
...
function newground() {
	...
	if (sessionStorage.getItem("Math") != null) {
		console.log(sessionStorage.getItem("Math"))
		document.body.innerHTML = sessionStorage.getItem("Math")
	}
	else {
	var x = 0
	var y = 0
	...
	for(var i=0; i<10; i++)
	{
		...
		sessionStorage.setItem("Math", document.body.innerHTML)
	}
